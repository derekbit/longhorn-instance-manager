...
_DISKSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='EngineGet',
    full_name='imrpc.DiskService.EngineGet',
    index=8,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='ReplicaWatch',
    full_name='imrpc.DiskService.ReplicaWatch',
    index=10,
    containing_service=None,
    input_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    output_type=_REPLICA,
  ...
  _descriptor.MethodDescriptor(
    name='EngineWatch',
    full_name='imrpc.DiskService.EngineWatch',
    index=11,
    containing_service=None,
    input_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    output_type=_ENGINE,
