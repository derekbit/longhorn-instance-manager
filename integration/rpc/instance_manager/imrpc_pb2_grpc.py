...
def add_ProcessManagerServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'ProcessCreate': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=imrpc__pb2.ProcessCreateRequest.FromString,
          response_serializer=imrpc__pb2.ProcessResponse.SerializeToString,
      ),
      'ProcessDelete': grpc.unary_unary_rpc_method_handler(
          servicer.ProcessDelete,
          request_deserializer=imrpc__pb2.ProcessDeleteRequest.FromString,
          response_serializer=imrpc__pb2.ProcessResponse.SerializeToString,
      ),
      'ProcessGet': grpc.unary_unary_rpc_method_handler(
          servicer.ProcessGet,
          request_deserializer=imrpc__pb2.ProcessGetRequest.FromString,
          response_serializer=imrpc__pb2.ProcessResponse.SerializeToString,
      ),
      'ProcessList': grpc.unary_unary_rpc_method_handler(
          servicer.ProcessList,
          request_deserializer=imrpc__pb2.ProcessListRequest.FromString,
          response_serializer=imrpc__pb2.ProcessListResponse.SerializeToString,
      ),
      ...
      'ProcessReplace': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=imrpc__pb2.ProcessReplaceRequest.FromString,
          response_serializer=imrpc__pb2.ProcessResponse.SerializeToString,
      ),
