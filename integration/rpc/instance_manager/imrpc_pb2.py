...
_VERSIONRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='instanceManagerDiskServiceAPIVersion', full_name='VersionResponse.instanceManagerDiskServiceAPIVersion', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='instanceManagerDiskServiceAPIMinVersion', full_name='VersionResponse.instanceManagerDiskServiceAPIMinVersion', index=8,
