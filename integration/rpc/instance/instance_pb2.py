...
_INSTANCESPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='process_specific', full_name='imrpc.InstanceSpec.process_specific', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='spdk_specific', full_name='imrpc.InstanceSpec.spdk_specific', index=7,
