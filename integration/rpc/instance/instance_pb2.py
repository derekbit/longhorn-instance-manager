...
_INSTANCECREATEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='expose_required', full_name='imrpc.InstanceCreateRequest.expose_required', index=1,
