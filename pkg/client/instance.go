...
func (c *InstanceServiceClient) VersionGet() (*meta.VersionOutput, error) {
	...
	return &meta.VersionOutput{
		...
		InstanceManagerInstanceServiceAPIVersion:    int(resp.InstanceManagerInstanceServiceAPIVersion),
		InstanceManagerInstanceServiceAPIMinVersion: int(resp.InstanceManagerInstanceServiceAPIMinVersion),
	}, nil
}
