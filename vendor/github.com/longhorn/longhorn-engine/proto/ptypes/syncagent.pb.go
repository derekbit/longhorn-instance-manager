...
type SnapshotHashRequest struct {
	...
	ConcurrentLimit      int32    `protobuf:"varint,3,opt,name=concurrent_limit,json=concurrentLimit,proto3" json:"concurrent_limit,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *SnapshotHashRequest) GetSnapshotNames() []string {
	if m != nil {
...
func (m *SnapshotHashRequest) GetConcurrentLimit() int32 {
	if m != nil {
...
var fileDescriptor_68e10ca3dfff6283 = []byte{
	...
	,
}
