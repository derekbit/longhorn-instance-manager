...
func (t *Task) AddRestoreReplica(volumeSize int64, replica string) error {
	...
	if volume.ReplicaCount == 0 {
		return t.client.VolumeStart(volumeSize, replica)
	}
...
func (t *Task) AddReplica(volumeSize int64, replica string) error {
	volume, err := t.client.VolumeGet()
	if err != nil {
		return err
	}
...
func (t *Task) StartWithReplicas(replicas []string) error {
	...
	return t.client.VolumeStart(volume.Size, replicas...)
}
