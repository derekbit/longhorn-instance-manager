...
func (s *Server) ReplicaList(ctx context.Context, req *empty.Empty) (*ptypes.ReplicaListResponse, error) {
	// TODO: Implement this
	return &ptypes.ReplicaListResponse{}, nil
}

func (s *Server) ReplicaWatch(req *empty.Empty, srv ptypes.SPDKService_ReplicaWatchServer) error {
	// TODO: Implement this
	return nil
}
...
func (s *Server) EngineList(ctx context.Context, req *empty.Empty) (*ptypes.EngineListResponse, error) {
	// TODO: Implement this
	return &ptypes.EngineListResponse{}, nil
}

func (s *Server) EngineWatch(req *empty.Empty, srv ptypes.SPDKService_EngineWatchServer) error {
	// TODO: Implement this
	return nil
}
...
func (s *Server) VersionDetailGet(context.Context, *empty.Empty) (*ptypes.VersionDetailGetReply, error) {
	// TODO: Implement this
