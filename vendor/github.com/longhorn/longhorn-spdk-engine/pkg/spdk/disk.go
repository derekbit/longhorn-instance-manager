...
func (s *Server) DiskCreate(ctx context.Context, req *ptypes.DiskCreateRequest) (*ptypes.Disk, error) {
...
func (s *Server) DiskDelete(ctx context.Context, req *ptypes.DiskDeleteRequest) (*emptypb.Empty, error) {
	log := logrus.WithFields(logrus.Fields{
		"diskName": req.DiskName,
...
func (s *Server) DiskGet(ctx context.Context, req *ptypes.DiskGetRequest) (*ptypes.Disk, error) {
	log := logrus.WithFields(logrus.Fields{
		"diskName": req.DiskName,
		"diskPath": req.DiskPath,
	})
...
func (s *Server) validateDiskCreateRequest(req *ptypes.DiskCreateRequest) error {
...
func (s *Server) lvstoreToDisk(diskPath, lvstoreName, lvstoreUUID string) (*ptypes.Disk, error) {
