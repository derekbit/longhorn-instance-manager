...
type ReplicaStream struct {
	stream ptypes.SPDKService_ReplicaWatchClient
}

func NewReplicaStream(stream ptypes.SPDKService_ReplicaWatchClient) *ReplicaStream {
...
type EngineStream struct {
	stream ptypes.SPDKService_EngineWatchClient
}

func NewEngineStream(stream ptypes.SPDKService_EngineWatchClient) *EngineStream {
	return &EngineStream{
		stream,
	}
}
